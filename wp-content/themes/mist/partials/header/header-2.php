...
<div id="header-main" class="header-main-section navbar">
	<div class="container">				
		...
		<!-- ============ Logo ============ -->
		<div class="navbar-header navbar-right nav-respons zozo-logo<?php echo esc_attr( $logo_class ); ?>">
			<!-- ==================== Toggle Icon ==================== -->
