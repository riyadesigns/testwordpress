		...
		<div class="navbar-collapse zozo-topnavbar-collapse collapse">
			...
			<ul class="nav navbar-nav navbar-right zozo-top-right">
				...
				<li class="header-details-box">
					...
					<div class="header-details-info header-address"><?php echo do_shortcode( $zozo_options['zozo_header_address'] ); ?></div>
				</li>
				<?php } ?>
				
				<?php if( isset( $zozo_options['zozo_header_business_hours'] ) && $zozo_options['zozo_header_business_hours'] != '' ) { ?>
				<li class="header-details-box">
					<div class="header-details-icon header-business-icon"><i class="fa fa-clock-o"></i></div>
					<div class="header-details-info header-business-hours"><?php echo do_shortcode( $zozo_options['zozo_header_business_hours'] ); ?></div>
				</li>
				<?php } ?>
				...
				<li class="header-details-box">
					...
					<div class="header-details-info header-contact-details">
						<strong><?php echo do_shortcode( $zozo_options['zozo_header_phone'] ); ?></strong>
						<span><?php echo '<a href="mailto:'.esc_attr( $zozo_options['zozo_header_email'] ).'">'.esc_html( $zozo_options['zozo_header_email'] ).'</a>'; ?></span>
					</div>
				</li>
				<?php } ?>
			</ul>
